...
public class DesktopApplication2View extends FrameView {
    ...
    private void initComponents() {
        ...
        mainPanel.add(jSlider1, gridBagConstraints);

        menuBar.setName("menuBar"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(nbguitest.DesktopApplication2.class).getContext().getResourceMap(DesktopApplication2View.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(nbguitest.DesktopApplication2.class).getContext().getActionMap(DesktopApplication2View.class, this);
